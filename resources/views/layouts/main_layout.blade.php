...
<body data-new-gr-c-s-check-loaded="14.993.0" data-gr-ext-installed="" class="bg-dark">

<header class="d-flex flex-column flex-md-row align-items-center  px-md-4 mb-3 bg-dark text-white border-bottom shadow-sm">
    <div class="w-25">
    ...
    @guest
        <a class="btn btn-outline-primary fw-bold" href="{{ route('register') }}">Sign up</a>
        <a class="btn btn-outline-primary fw-bold mx-2" href="{{ route('sign_in') }}">Log-in</a>
    @endguest
    @auth
